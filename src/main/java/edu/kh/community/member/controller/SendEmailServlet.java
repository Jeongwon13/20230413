...
public class SendEmailServlet extends HttpServlet{
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		String fromEmail = "cs.choijeongwon@gmail.com"; // 보내는 사람으로 표시될 이메일 (이메일 따라서 안될수도 있음)
		...
		final String smtpEmail = "cs.choijeongwon@gmail.com"; // 이메일
		final String password = "wvlbfesxsupxidsb"; // 발급 받은 비밀번호
